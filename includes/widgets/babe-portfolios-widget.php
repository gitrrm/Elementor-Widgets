...
/**
 * Class Babe_Portfolios_Widget
 *
 * This class defines the Babe Portfolios Widget for Elementor.
 */

class Babe_Portfolios_Widget extends Widget_Base
{
    ...
    {
        return __('Babe Portfolios', 'babe-addons');
    }
     ...
     *
     * Different input fields to allow the user to change and customize the widget settings.
     */
    protected function register_controls()    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Display Layout', 'babe-addons'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    '2-column' => __('2 Column', 'babe-addons'),
                    '3-column' => __('3 Column', 'babe-addons'),
                    'list-view' => __('List View', 'babe-addons'),
                    'assorted' => __('Assorted', 'babe-addons'),
                ],
                'default' => '3-column',
            ]
        );
        ...
        $this->add_control(
            'babe_portfolio_list_by_id_or_slug', 
            [
        ...
        $this->add_control('exclude_babe_portfolio_list_by_id_or_slug', [
        ...
        // Order By Control
        $this->add_control('babe_portfolio_list_primary_order', [
        ...
        $this->add_control('babe_portfolio_list_order_direction', [
        ...
        $this->add_control(
            'babe_portfolio_list_date_format',
            [
        ...
        $this->add_control(
            'babe_portfolio_list_custom_date_format',
            [
                'label' => __('Custom Date Format', 'babe-addons'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => 'F j, Y',
                'condition' => [
                    'babe_portfolio_list_date_format' => 'custom',
                ],
        ...
        $this->start_controls_section(
            'babe_portfolio_list_style_section',
            [
        ...
        // Title Alignment
        $this->add_control(
            'babe_portfolio_list_title_alignment',
            [
        ...
        $this->start_controls_tabs('babe_portfolio_list_title_color_tabs');

        // Normal State Tab
        $this->start_controls_tab(
            'babe_portfolio_list_title_color_normal_tab',
            [
        ...
        $this->add_control(
            'babe_portfolio_list_title_color_normal',
            [
        ...
        // Hover State Tab
        $this->start_controls_tab(
            'babe_portfolio_list_title_color_hover_tab',
            [
        ...
        $this->add_control(
            'babe_portfolio_list_title_color_hover',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'babe_portfolio_list_title_typography',
        ...
        $this->add_control(
            'babe_portfolio_list_title_margin',
            [
        ...
        $this->add_control(
            'babe_portfolio_list_title_padding',
            [
        ...
        // Excerpt Controls
        $this->start_controls_section(
            'babe_portfolio_list_excerpt_section',
            [
        ...
        // Excerpt Alignment
        $this->add_control(
            'babe_portfolio_list_excerpt_alignment',
            [
                'label' => __( 'Alignment', 'babe-addons' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->add_control(
            'babe_portfolio_list_excerpt_color',
            [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'babe_portfolio_list_excerpt_typography',
                'label' => __( 'Typography', 'babe-addons' ),
        ...
        $this->add_control(
            'babe_portfolio_list_excerpt_margin',
            [
        ...
        $this->add_control(
            'babe_portfolio_list_excerpt_padding',
            [
        ...
        // Start Date Controls
        $this->start_controls_section(
            'babe_portfolio_list_date_section',
            [
        ...
        // Start control tabs for normal and hover states
        $this->start_controls_tabs('babe_portfolio_list_date_color_tabs');

        // Normal State Tab
        $this->start_controls_tab(
            'babe_portfolio_list_date_color_normal_tab',
            [
                'label' => __( 'Normal', 'babe-addons' ),
            ]
        );
        ...
        // Icon Color Control for Normal State
        $this->add_control(
            'babe_portfolio_list_date_color_normal',
            [
        ...
        // Hover State Tab
        $this->start_controls_tab(
            'babe_portfolio_list_date_color_hover_tab',
            [
                'label' => __( 'Hover', 'babe-addons' ),
            ]
        );
        ...
        // Icon Color Control for Hover State
        $this->add_control(
            'babe_portfolio_list_date_color_hover',
            [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'babe_portfolio_list_date_typography',
                'label' => __( 'Typography', 'babe-addons' ),
        ...
        $this->add_control(
            'babe_portfolio_list_date_margin',
            [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'bpg_read_more_btn_typography',
                'label' => __( 'Typography', 'babe-addons' ),
                'selector' => '{{WRAPPER}} .babe-portfolio-widget .action-link a',
                'fields_options' => [
                    'typography' => [
                        'default' => 'yes',
                    ],
    ...
    protected function render() {
        ...
        $portfolio_layout_type = $settings['portfolio_layout_type'];
        ...
        $args = [
            ...
            'orderby' => $settings['babe_portfolio_list_primary_order'],
            'order' => $settings['babe_portfolio_list_order_direction'],
        ];
    
        // Include specific posts if provided
        if (!empty($settings['babe_portfolio_list_by_id_or_slug'])) {
            $args['post__in'] = array_map('trim', explode(',', $settings['babe_portfolio_list_by_id_or_slug']));
        }
    
        // Exclude specific posts if provided
        if (!empty($settings['exclude_babe_portfolio_list_by_id_or_slug'])) {
            $args['post__not_in'] = array_map('trim', explode(',', $settings['exclude_babe_portfolio_list_by_id_or_slug']));
        }
        ...
        if ($query->have_posts()) {
            ...
            // Pagination
            // if ( ! $hide_babe_portfolio_list_pagination ){
                /* if(!$show_on_bottom){
            ...
            // Date Format
            $date_format = $settings['babe_portfolio_list_date_format'] === 'custom' ? $settings['babe_post_grid_custom_date_format'] : $settings['babe_portfolio_list_date_format'];
            $formatted_date = get_the_date($date_format);
            if($portfolio_layout_type == '2-column' || $portfolio_layout_type == '3-column'){
                echo '<section>';
                echo '<div class="bt-row babe-portfolio-widget">';
                while ($query->have_posts()) {
                    $query->the_post();
                    $categories = get_the_terms(get_the_ID(), 'portfolio_category');
                    if($portfolio_layout_type == '3-column'){
                ...
                echo '</div>';
                echo '</section>';
            } elseif ($portfolio_layout_type == 'list-view'){
                echo '<section>';
                echo '<div class="bt-row babe-portfolio-widget">';
                while ($query->have_posts()) {
                    $query->the_post();
                    $categories = get_the_terms(get_the_ID(), 'portfolio_category');
                    ?>
                    <div class="bd-one-grid post-item bd-xsd-one-grid bd-mb-20">
                        <div class="bt-row grey-10">
                            <div class="bd-three-grid bd-sd-one-grid bd-xsd-one-grid bd-pl-0">
                                <a href="<?php the_permalink(); ?>" class="portfolio-image">
                                    <?php the_post_thumbnail(); ?>
                                </a>
                            </div>
                            <div class="bd-seven-grid bd-sd-one-grid">
                                <div class="portfolio-detail-wraper item-content-wrapper">
                                    <div class="portfolio-detail">
                                        <div class="portfolio-meta">
                                            <div class="portfolio-author"><i class="fa-regular fa-user"></i> <?php the_author(); ?></div>
                                            <div class="portfolio-date"><i class="fa-regular fa-calendar"></i> <?php echo esc_html($formatted_date); ?></div>
                                        </div>
                ...
                while ($query->have_posts()) {
                    ...
                    if ($count % 4 == 0) {
                    ?>
                    <div class="bd-one-grid post-item bd-md-two-grid bd-xsd-one-grid bd-mb-20">
                        <div class="bt-row grey-10">
                            <div class="bd-seven-grid bd-md-one-grid bd-pl-0">
                                <a href="<?php the_permalink(); ?>" class="portfolio-image">
                                    <?php the_post_thumbnail(); ?>
                                </a>
                            </div>                        
                            <div class="bd-three-grid bd-md-one-grid">
                                <div class="portfolio-detail-wraper item-content-wrapper">
                                    <div class="portfolio-detail">
                                        <div class="portfolio-meta">
                                            <div class="portfolio-author">
                    ...
                    <?php
                        ...
                        ?>
                        <div class="bd-three-grid post-item bd-md-two-grid bd-sd-two-grid bd-xsd-one-grid bd-mb-20">
                            <div>
                                <a href="<?php the_permalink(); ?>" class="portfolio-image">
                                    <?php the_post_thumbnail(); ?>
                                </a>
            ...
            if ($total_pages > 1) {
                ...
                echo '<div class="babe-portfolios-pagination">' . $pagination . '</div>';
            } */
